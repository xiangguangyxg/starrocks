...
public:
    ...
    bool lower_bound_exluded() const { return !lower_bound_included(); }
    ...
    bool is_all() { return is_minimum() && is_maximum(); }
...
private:
    ...
    bool _lower_bound_included;
    bool _upper_bound_included;
};
